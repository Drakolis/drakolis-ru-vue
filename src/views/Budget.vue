<template>
  <v-container style="height:100%">
          ...
          <v-flex xs12 class="mb-2">
            <v-card>
              <v-card-actions>
                ...
                <v-btn v-if="multipleAccountsFeature" flat color="blue">
                  Add Transfer
                  <v-icon class="ml-2">
    ...
    <popups :update-accounts="updateAccounts" />
  </v-container>
</template>
...
import ChartDemo from '@/components/Budget/ChartDemo.vue';
import AccountSelector from '@/components/Budget/AccountSelector/index.vue';
import Popups from '@/components/Budget/Popups/index.vue';
